...
template <typename T>
Network<T>::Network(NetworkType type, std::string_view name, const int af,const int soketType,const int protocol, const u_short port,
...
// }
// template <typename T = int>
// void Network<T>::StartProcessingData()
// {
//     if (_type == server)
//     {
...
//     return index;
// }
// DataType Network::DataToStrConverions(char *charStr)
// {
//     return (DataType)charStr;
// }

// char* Network::StrToDataConverion(DataType data)
// {
//     return (char*)data;
// }
